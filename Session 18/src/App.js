...
function App() {
  ...
  return (
    <div className='bg-[#184642] text-[#978d61]' >
      ...
      <motion.h1 animate={{opacity:1,scale:[1.3,0.5,1.0],}} initial={{opacity:0}} exit={{opacity:0}}
      transition={{ease:"easeOut",duration:5}} className='text-[12rem] w-4/5 m-auto pt-60 text-center milky text-[color: rgb(245 158 11)] '>PRISMA</motion.h1>

      <div className='text-center poppins pb-80 mt-32 flex align-center justify-center'>

        <input placeholder='Enter Anything...' className='bg-transparent rounded-full p-4 text-[#978d61] placeholder:text-[#978d61] placeholder:text-right border-2 border-[#978d61] outline-[#978d61] w-1/3' value={img} onChange={(e) => setImg(e.target.value)}/>
